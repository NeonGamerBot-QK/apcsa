...
public class Magpie5b
{
    ...
    /**
     * Counts how many words from statement also appears in the File "keywords.txt"
     * @param the statement from the user
     * @return a count of how many words in statement appears in keyword.txt
     */
    private int countKeyWords(String statement) throws IOException
    {
        int count = 0;
