...
public class MagpieGUIRunner2
{
    ...
    private Magpie2 magpie;
    
    public MagpieGUIRunner2()
    {
        magpie = new Magpie2();
        frame = new JFrame();
    ...
    class ReplyButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            ...
            chat += "\n" + "Magpie: " + magpie.getResponse(replyTextField.getText());
    ...
    {
        MagpieGUIRunner2 init = new MagpieGUIRunner2();
    }
}