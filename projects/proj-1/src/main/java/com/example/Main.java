...
public class Main {
  ...
  public static void main(String[] args) {
    try (Scanner user = new Scanner(System.in)) {
      ...
      System.out.println(
        "The ones digit is of " +
        greaterThen1000 +
        " is " +
        everythingButTheOnesDigit
      );
      System.out.println(
        "If you remove the ones digit, you get " +
        ("" + greaterThen1000).replace(everythingButTheOnesDigitStr, "")
      );
      System.out.println("Enter a double");
      double decimal = user.nextDouble();
      int decInt = (int) decimal;
      System.out.println(
        "The truncated version of " + decimal + " is " + decInt
      );
    }
  }
}
