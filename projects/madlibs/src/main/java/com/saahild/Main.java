...
public class Main {
  ...
  private static String makeMadLib(
    ...
    return new StringBuilder()
      .append(
        "It was the best of times in {b-year}, it was the worst of times in {ba-year},\n"
      )
      .append(
        "it was the age of wisdom for {name}, it was the age of foolishness in {city},\n"
      )
      .append(
        "it was the epoch of {cool-word}, it was the epoch of {bad-word},\n"
      )
      .append("it was the season of {light}, it was the season of {dark},\n")
      .append(
        "it was the spring of with a {sp-per}% chance of hope, it was the winter of despair with a {dsp-per}% chance.\n"
      )
      .append(
        "we had everything before us, we had nothing before us - bye {name}"
      )
      .toString()
      .replace("{b-year}", intToStr(bYear))
      .replace("{ba-year}", intToStr(baYear))
      .replace("{sp-per}", intToStr(spPer))
      .replace("{dsp-per}", intToStr(dspPer))
      .replace("{name}", name)
      .replace("{city}", city)
      .replace("{light}", light)
      .replace("{dark}", dark)
      .replace("{cool-word}", coolword)
      .replace("{bad-word}", badword)
      .replace("{name}", name);
  }
}
